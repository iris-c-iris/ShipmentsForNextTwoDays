...
public class Project4 {
    ...
    public static Train[] readFile( String inputFileName ) {
        ...
        Train[] t = new Train[numberOfTrains];
        ...
        {
            //read through file for length of array t
            for( int i = 0; i < t.length; i++ )
            {
                ...
                //create Train object at index i of t[], params are variables assigned above
                t[i] =  new Train( origin, departure, stops, duration );
                ...
                while( in.hasNextInt() && in.hasNextLine() ) //check for int and lines to read
                {
                    ...
                    t[i].loadCargo( cargoType, cargoAmount, cargoWeightPer );
